...
#define LABEL_SAFETY 3    // AI标签：普通车辆
#define LABEL_CONE 4      // AI标签：锥桶
#define LABEL_CROSSWALK 5 // AI标签：斑马线
#define LABEL_DANGER 6    // AI标签：危险车辆
#define LABEL_EVIL 7      // AI标签：恐怖分子
#define LABEL_BLOCK 8     // AI标签：障碍物
#define LABEL_PATIENT 9   // AI标签：伤员
#define LABEL_PROP 10      // AI标签：道具车
#define LABEL_SPY 11      // AI标签：嫌疑车辆
#define LABEL_THIEF 12    // AI标签：盗贼
#define LABEL_TUMBLE 13   // AI标签：跌倒
