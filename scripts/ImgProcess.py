...
class ImgProcess:
    ...
    def __init__(self) -> None:
        ...
        self.landmark = {"StartLine": False, "Hill": False,
                         "Roundabout1": False, "Fork": False, "Yaw": 0.0}
        # print("ImgProcess")
    ...
    def roundaboutGetInMid(self, U: bool = False):
        ...
        self.ppoint((self.roundaboutEntering.i,
                    self.roundaboutEntering.j)), self.ppoint((dpi, dpj))
        self.fitter[U].twoPoints(
            dpi, dpj, self.roundaboutEntering.i, self.roundaboutEntering.j)
    ...
    def work(self):
        ...
        self.landmark["Roundabout1"] = "None" if not self.roundaboutChecker.check(
        ) else "Right" if self.roundaboutChecker.side else "Left"
